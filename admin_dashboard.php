    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="admin_dashboard.php">
                <i class="bi bi-train-front-fill me-2"></i>RailConnect <span class="badge bg-danger">Admin</span>
            </a>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-2 p-0 admin-sidebar">
                <div class="pt-4 pb-3 px-3 text-center text-white">
                    <div class="d-inline-block rounded-circle bg-danger text-white p-2 mb-2" style="width: 60px; height: 60px; font-size: 1.5rem; line-height: 40px;">
                ...
                <nav class="nav flex-column mt-2">
                    <a class="nav-link active mb-1" href="admin_dashboard.php">
                        <i class="bi bi-speedometer2 me-2"></i> Dashboard
                    </a>
                    <a class="nav-link mb-1" href="admin_trains.php">
                        <i class="bi bi-train-front me-2"></i> Manage Trains
                    </a>
                    ...
                    <a class="nav-link mb-1" href="admin_bookings.php">
