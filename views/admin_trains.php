...
require_once BACKEND_PATH . 'admin_trains.php';
?>
                                ...
                                <tbody>
                                    <?php foreach ($trains as $train): ?>
                                        <tr>
                                            ...
                                            <td><?php echo $train['total_first_class_seats']; ?></td>
                                            <td><?php echo $train['total_second_class_seats']; ?></td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <button class="btn btn-sm btn-outline-primary" 
                                                            ...
                                                            data-first-class="<?php echo $train['total_first_class_seats']; ?>"
                                                            data-second-class="<?php echo $train['total_second_class_seats']; ?>"
                                                            data-has-wifi="<?php echo $train['has_wifi']; ?>"
                                                            data-has-food="<?php echo $train['has_food']; ?>"
                                                            data-has-power="<?php echo $train['has_power_outlets']; ?>">
                                                        <i class="bi bi-pencil me-1"></i>Edit
                                                    </button>
                                                    <form action="admin_trains.php" method="POST" class="d-inline">
